...
START_TEST(pow_test1) {
  ck_assert_double_eq_tol(s21_pow(5, 0.5), pow(5, 0.5), 0.000001);
}
END_TEST
...
START_TEST(pow_test7) {
  ck_assert_double_eq_tol(s21_pow(1, -1.2), pow(1, -1.2), 0.000001);
}
END_TEST

START_TEST(pow_test8) {
  ck_assert_double_eq_tol(s21_pow(0.0000001, 23), pow(0.0000001, 23), 0.000001);
}
END_TEST

START_TEST(pow_test9) {
  ck_assert_double_eq_tol(s21_pow(999999999, 23), pow(999999999, 23), 0.000001);
}
END_TEST
